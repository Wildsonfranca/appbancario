...
if __name__=='__main__':
    ...
    while True:
        ...
        if opcao == '1':
            ...
            correntista['Nome']= input(f'informe o nome a ser cadastrado:')
            correntistas.append(correntista)
            print(f'{correntista['Nome']} cadastrado co sucesso .')
            continue
        ...
        # avança para o próximo loop caso o nome não seja encontrado
            ...
            try:
                ...
                print('Não foi possével deletar conta.')
            continue
        #encerra programa 
        elif opcao == '5':
            break
